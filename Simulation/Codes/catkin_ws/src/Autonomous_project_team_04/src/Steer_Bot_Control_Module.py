...
#######################################################################
#Initialize ROS Node
rospy.init_node('Steer_Bot_Control_Module') #Identify ROS Node
#######################################################################
...
def callback_Control_Steering(data):
 global Steer_Cont, flag_Steer	#Identify msg variable created as global variable
...
def callback_Control_Velocity(data):
 global Vel_Cont, flag_Vel	#Identify msg variable created as global variable
